                        ...
                        <form class="row g-3 needs-validation" novalidate action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom03" name="firma" placeholder="F.eks. Aarhus Universitet" required>
                                    <div class="valid-feedback"></div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom04" name="cvr_nummer" aria-describedby="inputGroupPrepend" pattern=".{8}" placeholder="Skriv 8-cifret CVR-nummer her" required>
                                    <div class="invalid-feedback">
