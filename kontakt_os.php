                        ...
                        <form class="row g-3 needs-validation" novalidate action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                            ...
                            <div class="row py-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control" id="validationCustom03" name="email" placeholder="Skriv her" required>
                                        <div class="invalid-feedback"> Dette er ikke en email</div>
                                    </div>

                                    <div class="col-md-6">
                                        <label for="validationCustom01" class="form-label">Telefonnummer</label>
                                        <input type="text" class="form-control" id="validationCustom04" name="telefonnummer" placeholder="Skriv her" required>
                                        <div class="valid-feedback"></div>
                                    </div>
                            </div>
                            ...
                            <div class="row">
                                    <div class="form-floating mb-3 py-5">
                                        ...
                                        <textarea class="form-control" id="message" name="besked" style="height: 10rem" data-sb-validations="required"></textarea>
