            ...
            echo "  <div class='container px-5 my-5'>
                        <div class='text-center'>
                            <h1 class='fw-bolder'>Tak for din anmodning</h1>
                                <p class='lead fw-normal text-muted mb-5'> Du vil modtage et login, når du er oprettet i systemet som kunde. Bemærk at der i øjeblikket er ventetid på ca. 7 år </p>
                        </div>
                    </div>";
